...
export const siteContent: SiteContent = {
  ...
  ambientStickers: [
    ...
    { id: "s8", text: "tumblr-coded still", className: "top-[8%] left-[12%] hidden 2xl:block", rotate: 3 },
    { id: "s9", text: "San Myshuno afterglow", className: "bottom-[52%] right-[3%] hidden xl:block", rotate: -5 },
  ...
  universeRibbons: [
    ...
    { id: "r3", text: "girlhood archive", className: "top-[44%] left-[8%] hidden lg:block", rotate: -4 },
    { id: "r4", text: "for the romanticized sim players", className: "bottom-[38%] right-[10%] hidden 2xl:block", rotate: 7 },
    ...
    { id: "r8", text: "willow creek diaries", className: "bottom-[24%] right-[18%] hidden xl:block", rotate: 6 },
    { id: "r9", text: "Amanda · Leila · Summer", className: "top-[33%] right-[4%] hidden 2xl:block", rotate: -5 },
    { id: "r10", text: "tartosa romance pass", className: "bottom-[60%] right-[4%] hidden lg:block", rotate: 8 },
  ...
  whispers: {
    loaderLine: "Dreaming in gloss, grain, and girl-coded silver.",
    heroAside: "For girls who romanticize loading screens — Amanda, Summer, Leila still rendering.",
    betweenProjectsAndAbout: "Made slowly, like favorite outfits pinned twice before leaving the house.",
    betweenAboutAndApps: "Saved somewhere between chrome breath, stardust, and a San Myshuno balcony.",
    ...
    betweenCcAndJournal: "After midnight, everything feels editorial — Tartosa waves in the tab bar.",
    betweenJournalAndMembership: "Curated under silver light — for patrons who collect feelings, not files.",
    contactFootnote: "Girlhood rendered in pixels — gloss, grain & the quiet obsession of a save file.",
    archiveMicroNotes: [
