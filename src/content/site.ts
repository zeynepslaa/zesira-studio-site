...
export const siteContent: SiteContent = {
  ...
  ambientStickers: [
    ...
    { id: "s3", text: "digital femininity", className: "bottom-[28%] right-[6%] hidden md:block", rotate: 5 },
    { id: "s4", text: "issue no.001 — not for the timeline", className: "top-[52%] right-[12%] hidden 2xl:block", rotate: -3 },
    { id: "s5", text: "tartosa romance pass", className: "bottom-[18%] left-[5%] hidden lg:block", rotate: -8 },
    { id: "s6", text: "silver tabs only", className: "top-[22%] left-[8%] hidden xl:block", rotate: 7 },
    { id: "s7", text: "editor’s notes", className: "bottom-[40%] left-[3%] hidden 2xl:block", rotate: -4 },
    { id: "s8", text: "currently rebuilding willow creek", className: "top-[8%] left-[12%] hidden 2xl:block", rotate: 3 },
    { id: "s9", text: "late nights in san myshuno", className: "bottom-[52%] right-[3%] hidden xl:block", rotate: -5 },
    { id: "s10", text: "for the girls who romanticize everything", className: "top-[70%] left-[6%] hidden lg:block", rotate: 6 },
  ],
  floatingSystems: {
  ...
  universeRibbons: [
    ...
    { id: "r6", text: "tartosa romance pass", className: "bottom-[52%] left-[12%] hidden lg:block", rotate: 4 },
    { id: "r7", text: "editor's notes", className: "top-[72%] left-[18%] hidden 2xl:block", rotate: -3 },
    { id: "r8", text: "Amanda · Summer · Leila", className: "bottom-[24%] right-[18%] hidden xl:block", rotate: 6 },
    { id: "r9", text: "issue no.001", className: "top-[33%] right-[4%] hidden 2xl:block", rotate: -5 },
    { id: "r10", text: "saved from a late night build session", className: "bottom-[60%] right-[4%] hidden lg:block", rotate: 8 },
